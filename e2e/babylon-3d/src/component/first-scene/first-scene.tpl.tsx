...
export default (component: FirstScene) => (
  <fragment>
    <canvas ref={{ canvas: component }}></canvas>

    <iframe ref={{ iframe: component }} src="https://www.youtube-nocookie.com/embed/EZNIQzRkLUw?autoplay=1" frameBorder="0">
      {" "}
    </iframe>

    <svg id="logo" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 52.916664 52.916668" height="2rem" width="2rem">
      <g transform="translate(0,-244.08332)">
        <g transform="matrix(0.26458333,0,0,0.26458466,-157.1625,225.5587)">
          <path style="fill:#ffffff" d="m 731.053,219.356 h -18.051 l 0.207,-73.981 -29.543,-6.708 V 120.645 L 763,137.978 v 18.023 l -30.916,-6.251 z" />

          <path style="fill:#ffffff" d="M 594,70.014 V 270.013 H 794 V 70.014 Z M 777.67,253.692 H 610.33 V 86.343 h 167.34 z" />
