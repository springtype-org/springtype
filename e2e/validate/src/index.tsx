...
import { validation, IsDefined  } from "../../../src/core/validate";
...
export class TemplateName extends st.component implements ILifecycle {
  ...
  constructor() {
    ...
    this.name = "SpringType v4";

    this.foo(undefined);
  }

  foo(@IsDefined() test: any) {
    console.log('Makes sure that test is always defined!');
  }
