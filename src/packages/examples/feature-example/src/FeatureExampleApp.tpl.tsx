...
export default (view: FeatureExampleApp) =>
    ...
    <div>
        ...
        <svg id="SvgjsSvg1006" width="100%" height="240" xmlns="http://www.w3.org/2000/svg" version="1.1"
            ...
            <rect id="SvgjsRect1010" width="37.027027%" height="15" y="20" fill="#ff0066" />
            ...
            <rect id="SvgjsRect1014" width="16.972972%" height="15" y="40" fill="#ff0066" />
            ...
            <rect id="SvgjsRect1018" width="4.405405%" height="15" y="60" fill="#ff0066" />
            ...
            <rect id="SvgjsRect1024" width="74.594594%" height="15" y="100" fill="#05bba6" />
            ...
            <rect id="SvgjsRect1028" width="21.756756%" height="15" y="120" fill="#05bba6" />
            ...
            <rect id="SvgjsRect1032" width="7.729729%" height="15" y="140" fill="#05bba6" />
            ...
            <rect id="SvgjsRect1038" width="83.243243%" height="15" y="180" fill="#999999" />
            ...
            <rect id="SvgjsRect1042" width="24.621621%" height="15" y="200" fill="#999999" />
            ...
            <rect id="SvgjsRect1046" width="8.594594%" height="15" y="220" fill="#999999" />
