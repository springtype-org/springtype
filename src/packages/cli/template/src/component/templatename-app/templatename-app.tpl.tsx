...
export default (component: TemplateNameApp) => <div class="container">
    <svg id="logo"
    ...
    <p>👉 Find me here: <code>src/web-component/templatename-app/templatename-app.tsx</code> 👈</p>
    <p>Create new elements: <code>npx st create</code></p>
